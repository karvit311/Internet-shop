        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-dark">
                    ...
                    <tr>
                        <td class="modal_delivery_date_address"><?php // $delivery['address'];?></td>
                        <td class="modal_delivery_date_date"><?php // $delivery['date'];?></td>
                        <td class="modal_delivery_date_time"><?php // $delivery['time'];?></td>
                    </tr>
                    <?php //}?>
                    </tbody>
                </table>
