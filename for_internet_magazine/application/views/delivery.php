...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="left-block-search-deliveries-by-city" style="margin-left:-300px;margin-top:62px;float:left; border:1px solid #f3d6d6; width:270px;"><h4 style=" text-decoration: underline; font-family:'Comic Sans MS', cursive, sans-serif">Search deliveries by cities:</h4>
                <?php
                ...
                <form method="post">
                    <div class="form-group">
                        <label for="FormControlSearchDeliveriesByCity" style="  font-family:'Comic Sans MS', cursive, sans-serif">Cities:</label>
            ...
            <div id="left-block-search-deliveries-by-supplier" style="margin-left:-300px;margin-top:247px;float:left; border:1px solid #f3d6d6; width:270px;"><h4 style="text-decoration: underline;  font-family:'Comic Sans MS', cursive, sans-serif">Search deliveries by suppliers:</h4>
                <?php
                ...
                <form method="post" class="left-block-search-by-supplier">
                    <div class="form-group">
                        <label for="FormControlSearchDeliveriesBySupplier" style="  font-family:'Comic Sans MS', cursive, sans-serif">Suppliers:</label>
            ...
            <div id="left-block-search-deliveries-by-date" style="margin-left:-300px;margin-top:427px;float:left; border:1px solid #f3d6d6; width:270px;"><h4 style="text-decoration: underline;  font-family:'Comic Sans MS', cursive, sans-serif">Search deliveries by date:</h4>
            ...
            <div id="left-block-add-new-supplier" style="float:left;margin-left:-300px;margin-top:553px;border:1px solid #f3d6d6; width:270px;padding:20px;">
                <button id="add_new_supplier_left_block" class="btn-default" type="button" style="background:rosybrown;color:#d4cbcb;height:50px;font-family:'Comic Sans MS', cursive, sans-serif"">Добавить нового поставщика</button>
            </div>
            <h2 style="margin-left:400px;  font-family:'Comic Sans MS', cursive, sans-serif">Deliveries for current week</h2>
...
<!--                            <button type="submit" name="add_new_delivery" id="add_new_delivery" class="btn btn-info" data-dismiss="modal" >Добавить</button>-->
            ...
            <div class="col-md-3" style="float:right;margin-right:-325px;border:1px solid #f3d6d6;">
                <h3 style="margin-left:50px;margin-bottom:20px;font-family:'Comic Sans MS', cursive, sans-serif">New products</h3>
                <?php
                $products = new \Application\models\Product();
                $res_products = $products->get_products();
                ?>
                <div id="block-news">
                    <img id="news-prev" src="/application/photo/img-prev.png" />
                    <div id="newsticker">
                        <ul>
                            <?php
                            foreach ($res_products as $key => $new) {?>
                                <li style="height:200px;">
                                    <a href="/"><img src="/application/photo/phone/<?= $new['photo'];?>"  title="<?= $new['name'];?>" width="170px" heigth="240px"></a>
                                </li>
                            <?php }?>
                        </ul>
                    </div>
                    <img id="news-next" src="/application/photo/img-next.png" />
                </div>
                    <script>
            ...
            <div style="border:1px solid #f3d6d6;">
                <h2 style="margin-left:400px;  font-family:'Comic Sans MS', cursive, sans-serif">Add new deliveries</h2>
                <!-- ADDING SUCCESS-->
    ...
    $(document).ready(function() {
        ...
        $('#search_deliveries_by_suppliers').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "/main/GetAllDeliveriesForThisSupplier",
        ...
        $('#left-block-search-by-city').click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "/main/GetAllDeliveriesForThisCity",
                ...
                success: function (response) {
                    $.each($(response), function (i,el) {
                        $.each($('.hour_delivery'), function (ii, ell) {
                            ...
                            if((city_id == el['city_id'])&&(date== el['date'])){
                                $(this).attr('time', el['time']);
                            }
                            var time = $(this).attr('time');
                            var date = $(this).attr('date');
                            if ((date == el['date'])&&(city_id == el['city_id'])) {
                                $(this).html(time);
                                ...
                                $(this).click(
                                    function () {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: "/main/GetInfoAboutDelivery",
                                            data: "time=" + time_atr +"&date=" + date_atr,
                                            dataType: "json",
                                            success: function (res) {
                                                var workers = JSON.stringify(res);
                                                var obj = JSON.parse(workers);
