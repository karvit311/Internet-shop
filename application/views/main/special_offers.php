...
<html lang="en">
    ...
    ?>
        ...
        foreach($res_products_pagination as $res_product_pagination) {
            ...
            $adjacents = 3;
            $page = $_GET['page'];
            $targetpage = "/main/SpecialOffers/?"; //your file name
...
<!--                    <h4 id="title_special_offers_main"> ПОСПЕШИ! ДВА ТОВАРА ПО ЦЕНЕ ОДНОГО!</h4>-->
                    <div class="body-products" style="display:flex;">
                        ...
                        <div class="col-md-3 newsticker-div special_offer_new_product_main ">
                            <h3>New products</h3>
                            <?php
                            $products = new \Application\models\Product();
