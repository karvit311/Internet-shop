            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="video_left_block">
                        <iframe src="https://www.youtube.com/embed/vlDzYIIOYmM" allowfullscreen width="265px"></iframe>
                    </div>
                    <div class="body-products" style="display:flex;">
                        <div id="computers" style="min-width:1189px;">
                            ...
                            ?>
                                <div class="column <?= $res_product['brand'];?> <?= $res_product['colour'];?>" email="<?= $email;?>" iid="<?= $res_product['id']; ?>"  real_price="<?= $res_product['price'];?>" price="<?= $res_product['price'] ?>" >
