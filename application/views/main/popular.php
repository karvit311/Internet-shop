                    ...
                    <div class="body-products" style="display:flex;">
                        <div id="computers" style="min-width:1189px;">
                            ...
                            <?php foreach ($res_products as $res_product){?>
                                <div class="column <?= $res_product['brand'];?> <?= $res_product['colour'];?>" email="<?= $email;?>" data-price="<?= $res_product['price']; ?>" real_price="<?= $res_product['price']?>" price="<?= $res_product['price']?>" iid="<?= $res_product['id']?>" >
                                    <div class="column-div">
                                        ...
                                        <?php }?>
                                        <?php if($res_product['discount'] == '1' && $res_product['popular'] == '1'){
                                        ...
                                        <?php }?><br>
                                        <?php if($res_product['popular'] == '1' && $res_product['popular'] == '1'){?>
