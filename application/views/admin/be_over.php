...
<!--        <script src="/application/js/admin.js"></script>-->
    ...
    <body>
        ...
        $res_products_pagination = $products_pagination->get_total_by_soon_be_over();
        foreach($res_products_pagination as $res_product_pagination) {
            $total = $res_product_pagination['total'];
            $adjacents = 3;
            $page = $_GET['page'];
            $targetpage = "/admin/BeOver/?"; //your file name
            ...
            $products = new \Application\models\Product();
                $res_products = $products->get_products_soon_be_over($limit,$start);
                        ...
                        <?php foreach ($res_products as $res_product){?>
                            <div class="column-admin <?= $res_product['brand'];?> <?= $res_product['colour'];?>" data-price="<?= $res_product['price']; ?>" price="<?= $res_product['price']?>" >
                                <div class="column-div">
                                    ...
                                    <?php }?>
                                    <img src="/application/photo/icons/be_over.png" width="45px;" height="45px;" class="column-img-be-over">
                                </div>
                                <div>
                                ...
                                <div style="" class="info_for_phone">
                                    <ul>
                                        <li>
                                ...
                                <button type="submit" iid="<?= $res_product['id']?>" price="<?= $res_product['price']?>" name="<?= $res_product['name']?>"  class="button-delete">Delete</button>
                            </div>
                        <?php }?>
                    </div>
                    <!-- Modal confirm -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h3 class="modal-title">Edition product will be soon over!</h3>
                                    ...
                                    <div class="modal-body edit_modal">
                                        <div id="modal_edit_about_images">
                                            <div class="modal_main_image_block">
                                                ...
                                                <div >
                                                    <input type="file" id="file" class="file-products-admin-main-image" name="file"/>
                                                </div>
                                            </div>
