...
//        $stmt->bindParam(":value_special_offer", $value_special_offer, \PDO::PARAM_STR);
        $stmt->bindParam(":end_date", $end_date, \PDO::PARAM_STR);
        $stmt->execute();
    }
//
//    public function insert_only_value_special_offer($id,$value_special_offer)
//    {
//        $conn = App::$app->get_db();
//        $stmt = $conn->prepare( "INSERT INTO special_offer (product_id,value_special_offer)  VALUES(:product_id,:value_special_offer)");
//        $stmt->bindParam(":product_id", $id, \PDO::PARAM_INT);
//        $stmt->bindParam(":value_special_offer", $value_special_offer, \PDO::PARAM_STR);
//        $stmt->execute();
//    }
...
//    public function update_special_offer_value($id,$value_special_offer)
//    {
//        $conn = App::$app->get_db();
//        $stmt = $conn->prepare("UPDATE special_offer SET value_special_offer = :value_special_offer WHERE product_id=:product_id");
//        $stmt->bindParam(":product_id", $id, \PDO::PARAM_INT);
//        $stmt->bindParam(":value_special_offer", $value_special_offer, \PDO::PARAM_STR);
//        $update = $stmt->execute();
//        return $update;
